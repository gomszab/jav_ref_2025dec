...
sectionDiv.appendChild(table); // hozzacsatolom a szekciodivhez
/**
...
sectionDiv.appendChild(simpleButton); // gomb hozzacsatolasa a szekciohoz
...
sectionDiv.appendChild(doubleButton); // gomb hozzacsatolasa a szekciohoz
